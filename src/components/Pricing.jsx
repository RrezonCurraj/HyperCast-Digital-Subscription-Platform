...
const plans = [
  {
    duration: '1 Month',
    price: '9.99',
    features: ['Ad-Free Streaming', '4K Ultra HD Quality', 'Unlimited Devices', 'Offline Downloads', 'Cinematic Experience', 'Cross-Platform Sync', 'Parental Controls', '24/7 Priority Support'],
    recommended: false
  },
  {
    duration: '3 Months',
